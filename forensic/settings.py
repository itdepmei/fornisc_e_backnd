...
SECRET_KEY = 'django-insecure-5@*g3a*o3dt!&a2n9yq#b+xnq=z=67mo5m9$g$(etyi6y$ndb_'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),   # 7 days
...
ASGI_APPLICATION = 'forensic.asgi.application'
